...
class DataValidationConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.base_file_path = os.path.join("mïce.csv")
...
class DataTransformationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_train_path = os.path.join(self.dara_transformation_dir,"transformed",TRAIN_FILE_NAME.replace("csv","npz"))
